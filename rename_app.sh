...
# Display name -> valid Dart package name (lowercase; spaces/hyphens -> _).
# Computed here: Windows/Linux CMake steps below already reference it, so it
# must not be deferred to step 7.
