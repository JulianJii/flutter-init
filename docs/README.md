<!--
  Flutter Riverpod Clean Architecture - 现代化文档首页
  (2025, by jessejii)
-->
...
<div style="position: relative; background: linear-gradient(120deg, #0175C2 0%, #13B9FD 100%); border-radius: 32px; margin: 40px 0 60px 0; box-shadow: 0 12px 48px rgba(1,117,194,0.18); overflow: hidden;">
  ...
  <div style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 90px 30px 70px 30px;">
    ...
    <div style="margin-top: 48px; display: flex; gap: 24px; flex-wrap: wrap; justify-content: center;">
      <a href="./getting_started.html" style="font-size: 1.3em; padding: 18px 44px; border-radius: 50px; font-weight: 700; background: linear-gradient(135deg, #fff, #e6f7ff); color: #0175C2; box-shadow: 0 10px 25px rgba(0,0,0,0.13); text-decoration: none; position: relative; overflow: hidden; transition: all 0.3s;">快速开始</a>
      <a href="./architecture.html" style="font-size: 1.3em; padding: 17px 40px; border-radius: 50px; font-weight: 600; border: 3px solid rgba(255,255,255,0.7); color: white; background: transparent; text-shadow: 0 1px 3px rgba(0,0,0,0.10); text-decoration: none; transition: all 0.3s;">探索架构</a>
    </div>
    <div style="margin-top: 32px;">
      <a href="https://github.com/jessejii/flutter_init" style="display: inline-flex; align-items: center; background: rgba(255,255,255,0.92); padding: 8px 18px; border-radius: 30px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); text-decoration: none; color: #333; font-weight: 600; font-size: 1em; transition: all 0.3s;">
        <svg style="width: 18px; height: 18px; margin-right: 8px;" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>
...
<section style="background: var(--features-bg); padding: 60px 0; border-radius: 20px; margin: 80px 0; position: relative; overflow: hidden;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; max-width: 1300px; margin: 0 auto; padding: 0 20px;">
    ...
    <div style="background: var(--clean-arch-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(1,117,194,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">通过领域层、数据层和表现层实现关注点分离，构建可维护的代码库。</p>
    </div>
    ...
    <div style="background: var(--riverpod-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(65,105,225,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">Riverpod 状态管理</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">强大且可测试的状态管理解决方案，支持依赖注入。</p>
    </div>
    ...
    <div style="background: var(--lang-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(25,118,210,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">🌐</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">多语言支持</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">完整的国际化支持，包含本地化资源和自动化生成。</p>
    </div>
    ...
    <div style="background: var(--biometric-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(103,58,183,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">🔐</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">生物识别认证</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">跨平台安全认证，支持 Face ID 和指纹识别。</p>
    </div>
    ...
    <div style="background: var(--flags-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(255,111,0,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">🧪</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">功能开关</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">A/B 测试和分阶段发布，支持远程配置。</p>
    </div>
    ...
    <div style="background: var(--analytics-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(0,150,136,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">📊</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">分析集成</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">通过灵活的日志记录跟踪用户行为和应用性能。</p>
    </div>
    ...
    <div style="background: var(--modular-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(63,81,181,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">🧩</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">模块化设计</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">以功能为中心的组织方式，提升可扩展性和可维护性。</p>
    </div>
    ...
    <div style="background: var(--responsive-gradient); border-radius: 16px; padding: 35px 30px; color: white; box-shadow: var(--card-box-shadow); transition: all 0.3s ease; position: relative; overflow: hidden; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(156,39,176,0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow=var(--card-box-shadow);">
      ...
      <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
      <div style="font-size: 3em; margin-bottom: 25px; text-shadow: var(--card-text-shadow);">📱</div>
      <h3 style="font-size: 1.6em; margin: 0 0 15px; font-weight: 700; text-shadow: var(--card-text-shadow);">响应式 UI</h3>
      <p style="margin: 0; line-height: 1.65; font-size: 1.05em; opacity: 0.9;">自适应布局，适配所有屏幕尺寸和平台。</p>
    </div>
  </div>
</section>
...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 30px; margin: 50px auto; max-width: 1200px; padding: 0 20px;">
  ...
  <div style="background: linear-gradient(135deg, #0175C2, #13B9FD); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(1, 117, 194, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">快速开始</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">快速设置，几分钟内启动项目</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">入门</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">设置</span>
    </div>
    <a href="./getting_started.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #3F51B5, #7986CB); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(63, 81, 181, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">架构</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">了解项目结构和 Clean Architecture 原则</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">设计</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">结构</span>
    </div>
    <a href="./architecture.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #FF9800, #FFB74D); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(255, 152, 0, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
    <div style="font-size: 2.8em; margin-bottom: 20px;">🛡️</div>
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">编码规范</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">最佳实践、代码检查规则和风格指南</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">最佳实践</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">代码检查</span>
    </div>
    <a href="./coding_standards.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #673AB7, #9575CD); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(103, 58, 183, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
    <div style="font-size: 2.8em; margin-bottom: 20px;">✨</div>
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">功能特性</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">探索所有可用功能及其实现方式</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">组件</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">API</span>
    </div>
    <a href="./features.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #009688, #4DB6AC); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(0, 150, 136, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
    <div style="font-size: 2.8em; margin-bottom: 20px;">💻</div>
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">示例</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">实际应用的实现示例和模式</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">代码</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">教程</span>
    </div>
    <a href="./examples.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #607D8B, #90A4AE); color: white; border-radius: 16px; padding: 35px 30px; box-shadow: 0 15px 30px rgba(96, 125, 139, 0.3); transition: all 0.35s ease; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; bottom: -30px; left: -20px; width: 80px; height: 80px; border-radius: 50%; background: rgba(255,255,255,0.1);"></div>
    <div style="font-size: 2.8em; margin-bottom: 20px;">🛠️</div>
    <h3 style="margin-top: 0; font-size: 1.8em; margin-bottom: 15px; font-weight: 700;">CLI 工具</h3>
    <p style="margin: 0 0 20px 0; line-height: 1.6; font-size: 1.1em; opacity: 0.9;">代码生成器和自动化脚本</p>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; margin-bottom: 25px;">
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">自动化</span>
      <span style="display: inline-block; background: rgba(255,255,255,0.15); padding: 6px 14px; border-radius: 30px; font-size: 0.9em;">脚本</span>
    </div>
    <a href="./tools.html" style="display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); color: white; padding: 14px 28px; border-radius: 40px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; font-size: 1.05em; box-shadow: 0 6px 15px rgba(0,0,0,0.15);">查看指南</a>
  </div>
</div>
...
<div style="background-image: var(--get-started-bg, linear-gradient(135deg, #f5f7fa 0%, #eef1f5 100%)); border-radius: 20px; padding: 40px; margin: 60px 0; position: relative; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.08); color: var(--get-started-text, #333);">
  ...
  <h2 style="color: var(--get-started-heading, #0175C2); font-size: 2.5em; margin-top: 0; margin-bottom: 20px; text-align: center; font-weight: 800; text-shadow: var(--get-started-text-shadow, none);">立即开始</h2>
  
  <p style="text-align: center; font-size: 1.2em; margin-bottom: 30px; max-width: 700px; margin-left: auto; margin-right: auto; color: var(--get-started-text, #333);">准备好使用最佳实践和坚实基础来构建下一个 Flutter 项目了吗？</p>
  ...
  <div style="background: var(--terminal-bg, #282c34); border-radius: 10px; padding: 5px; position: relative; margin: 30px 0; box-shadow: 0 10px 30px rgba(0,0,0,0.15); overflow: hidden;">
    <div style="position: absolute; top: 0; left: 0; right: 0; height: 40px; background: var(--terminal-header-bg, #21252b); display: flex; align-items: center; padding: 0 15px; border-radius: 10px 10px 0 0;">
      ...
      <div style="margin-left: 20px; color: #abb2bf; font-family: 'Monaco', monospace; font-size: 0.9em;">终端</div>
    </div>
    
    <pre style="margin-top: 40px; padding: 20px; overflow-x: auto; position: relative; background: transparent; border: none;"><code style="color: var(--terminal-text, #abb2bf); font-family: 'Fira Code', 'Monaco', monospace;"><span style="color: var(--terminal-command, #98c379);">git</span> <span style="color: var(--terminal-arg, #61afef);">clone</span> https://github.com/jessejii/flutter_init.git</code></pre>
  ...
  <p style="text-align: center; font-size: 1.1em; margin-top: 20px; color: var(--get-started-text, #333);">或使用 <a href="https://github.com/jessejii/flutter_init" style="color: var(--get-started-link, #0175C2); font-weight: 500;">此模板</a> 在 GitHub 上创建您自己的仓库。</p>
...
<div style="display: flex; flex-wrap: wrap; gap: 32px; justify-content: center; margin: 60px auto 80px auto; max-width: 1100px;">
  ...
  <div style="flex: 1 1 220px; min-width: 220px; max-width: 270px; background: var(--resources-card-bg); border: 1.5px solid rgba(1,117,194,0.15); border-radius: 22px; padding: 38px 28px 32px 28px; box-shadow: var(--resources-shadow); display: flex; flex-direction: column; align-items: center; transition: all 0.3s ease; backdrop-filter: blur(8px); position: relative; overflow: hidden;">
    ...
    <h3 style="margin: 0 0 12px 0; font-size: 1.3em; font-weight: 700; color: var(--resources-card-text); text-align: center;">Flutter 文档</h3>
    <p style="margin: 0 0 22px 0; line-height: 1.6; font-size: 1em; color: var(--resources-card-desc); text-align: center;">Flutter 官方文档和指南</p>
    <a href="https://docs.flutter.dev/" style="display: inline-block; background: linear-gradient(90deg, #0175C2, #13B9FD); color: white; padding: 10px 28px; border-radius: 30px; text-decoration: none; font-weight: 600; font-size: 1em; box-shadow: 0 4px 15px rgba(1,117,194,0.25); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">访问</a>
  </div>
  ...
  <div style="flex: 1 1 220px; min-width: 220px; max-width: 270px; background: var(--resources-card-bg); border: 1.5px solid rgba(103,58,183,0.15); border-radius: 22px; padding: 38px 28px 32px 28px; box-shadow: var(--resources-shadow); display: flex; flex-direction: column; align-items: center; transition: all 0.3s ease; backdrop-filter: blur(8px); position: relative; overflow: hidden;">
    ...
    <h3 style="margin: 0 0 12px 0; font-size: 1.3em; font-weight: 700; color: var(--resources-card-text); text-align: center;">Riverpod 文档</h3>
    <p style="margin: 0 0 22px 0; line-height: 1.6; font-size: 1em; color: var(--resources-card-desc); text-align: center;">了解更多关于 Riverpod 状态管理库的信息</p>
    <a href="https://riverpod.dev/" style="display: inline-block; background: linear-gradient(90deg, #673AB7, #9575CD); color: white; padding: 10px 28px; border-radius: 30px; text-decoration: none; font-weight: 600; font-size: 1em; box-shadow: 0 4px 15px rgba(103,58,183,0.25); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">访问</a>
  </div>
  ...
  <div style="flex: 1 1 220px; min-width: 220px; max-width: 270px; background: var(--resources-card-bg); border: 1.5px solid rgba(76,175,80,0.15); border-radius: 22px; padding: 38px 28px 32px 28px; box-shadow: var(--resources-shadow); display: flex; flex-direction: column; align-items: center; transition: all 0.3s ease; backdrop-filter: blur(8px); position: relative; overflow: hidden;">
    ...
    <h3 style="margin: 0 0 12px 0; font-size: 1.3em; font-weight: 700; color: var(--resources-card-text); text-align: center;">Clean Architecture 指南</h3>
    <p style="margin: 0 0 22px 0; line-height: 1.6; font-size: 1em; color: var(--resources-card-desc); text-align: center;">了解 Clean Architecture 原则</p>
    <a href="https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html" style="display: inline-block; background: linear-gradient(90deg, #4caf50, #81c784); color: white; padding: 10px 28px; border-radius: 30px; text-decoration: none; font-weight: 600; font-size: 1em; box-shadow: 0 4px 15px rgba(76,175,80,0.25); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">访问</a>
  </div>
  ...
  <div style="flex: 1 1 220px; min-width: 220px; max-width: 270px; background: var(--resources-card-bg); border: 1.5px solid rgba(255,152,0,0.15); border-radius: 22px; padding: 38px 28px 32px 28px; box-shadow: var(--resources-shadow); display: flex; flex-direction: column; align-items: center; transition: all 0.3s ease; backdrop-filter: blur(8px); position: relative; overflow: hidden;">
    ...
    <h3 style="margin: 0 0 12px 0; font-size: 1.3em; font-weight: 700; color: var(--resources-card-text); text-align: center;">Dart 风格指南</h3>
    <p style="margin: 0 0 22px 0; line-height: 1.6; font-size: 1em; color: var(--resources-card-desc); text-align: center;">遵循 Dart 代码最佳实践</p>
    <a href="https://dart.dev/guides/language/effective-dart" style="display: inline-block; background: linear-gradient(90deg, #ff9800, #ffb74d); color: white; padding: 10px 28px; border-radius: 30px; text-decoration: none; font-weight: 600; font-size: 1em; box-shadow: 0 4px 15px rgba(255,152,0,0.25); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">访问</a>
  </div>
</div>
  ...
  <div class="faq-container" style="display: flex; flex-wrap: wrap; gap: 28px; position: relative;">
    <details style="margin-bottom: 8px; border-radius: 20px; border: 1px solid var(--faq-border); background: var(--faq-bg); overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.06); transition: all 0.4s ease; position: relative; width: 100%; backdrop-filter: blur(10px);" open>
      ...
      <div style="padding: 5px 30px 26px 30px; border-top: 1px solid var(--faq-content-border); background: linear-gradient(to bottom right, rgba(1,117,194,0.02), transparent);">
        <p style="color: var(--faq-text); line-height: 1.8; font-size: 1.1em; margin-top: 16px;">可以，此模板基于 MIT 许可证授权，您可以在个人和商业项目中自由使用。虽然不要求，但我们很感激您的署名。</p>
      </div>
    </details>
    ...
    <details style="margin-bottom: 8px; border-radius: 20px; border: 1px solid var(--faq-border); background: var(--faq-bg); overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.06); transition: all 0.4s ease; position: relative; width: 100%; backdrop-filter: blur(10px);">
      ...
      <div style="padding: 5px 30px 26px 30px; border-top: 1px solid var(--faq-content-border); background: linear-gradient(to bottom right, rgba(103,58,183,0.02), transparent);">
        <p style="color: var(--faq-text); line-height: 1.8; font-size: 1.1em; margin-top: 16px;">此模板使用 Riverpod 3（基于代码生成的 Notifier 模式）作为主要状态管理解决方案。Riverpod 提供了一种既强大又可测试的响应式状态管理模式。该模板实现了跨不同功能管理状态的一致模式，包括组合本地和远程数据源。</p>
      </div>
    </details>
    ...
    <details style="margin-bottom: 8px; border-radius: 20px; border: 1px solid var(--faq-border); background: var(--faq-bg); overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.06); transition: all 0.4s ease; position: relative; width: 100%; backdrop-filter: blur(10px);">
      ...
      <div style="padding: 5px 30px 26px 30px; border-top: 1px solid var(--faq-content-border); background: linear-gradient(to bottom right, rgba(255,152,0,0.02), transparent);">
        <p style="color: var(--faq-text); line-height: 1.8; font-size: 1.1em; margin-top: 16px;">欢迎贡献！请查看我们的<a href="./contributing.html" style="color: var(--faq-link); text-decoration: none; font-weight: 600; transition: all 0.2s ease; padding-bottom: 2px; border-bottom: 2px solid rgba(19,185,253,0.3); box-shadow: 0 1px 0 rgba(19,185,253,0.1);">贡献指南</a>了解如何提交问题、功能请求和拉取请求。您也可以通过改进文档、添加示例或修复错误来提供帮助。</p>
      </div>
    </details>
  </div>
</div>
...
<p style="text-align: center; max-width: 800px; margin: 0 auto; font-size: 1.1em;">
  此项目基于 MIT 许可证授权。详情请参阅 <a href="https://github.com/jessejii/flutter_init/blob/main/LICENSE" style="color: #0175C2; font-weight: 500;">LICENSE</a> 文件。
</p>

<div style="text-align: center; margin-top: 50px; padding-top: 50px; border-top: 1px solid #eee;">
  <a href="https://github.com/jessejii/flutter_init" style="display: inline-flex; align-items: center; text-decoration: none; color: #333; font-weight: 600;">
    <svg style="width: 24px; height: 24px; margin-right: 8px;" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>
    <span>在 GitHub 上为项目加星</span>
  </a>
</div>
