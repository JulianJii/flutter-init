...
<div style="position: relative; background: linear-gradient(120deg, #0175C2 0%, #13B9FD 100%); border-radius: 32px; margin: 40px 0 60px 0; box-shadow: 0 12px 48px rgba(1,117,194,0.18); overflow: hidden;">
  ...
  <div style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 90px 30px 70px 30px;">
    ...
    <div style="margin-top: 32px;">
      <a href="https://github.com/jessejii/init" style="display: inline-flex; align-items: center; background: rgba(255,255,255,0.92); padding: 8px 18px; border-radius: 30px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); text-decoration: none; color: #333; font-weight: 600; font-size: 1em; transition: all 0.3s;">
...
<div style="background-image: var(--get-started-bg, linear-gradient(135deg, #f5f7fa 0%, #eef1f5 100%)); border-radius: 20px; padding: 40px; margin: 60px 0; position: relative; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.08); color: var(--get-started-text, #333);">
  ...
  <p style="text-align: center; font-size: 1.1em; margin-top: 20px; color: var(--get-started-text, #333);">或使用 <a href="https://github.com/jessejii/init" style="color: var(--get-started-link, #0175C2); font-weight: 500;">此模板</a> 在 GitHub 上创建您自己的仓库。</p>
...
<p style="text-align: center; max-width: 800px; margin: 0 auto; font-size: 1.1em;">
  此项目基于 MIT 许可证授权。详情请参阅 <a href="https://github.com/jessejii/init/blob/main/LICENSE" style="color: #0175C2; font-weight: 500;">LICENSE</a> 文件。
</p>

<div style="text-align: center; margin-top: 50px; padding-top: 50px; border-top: 1px solid #eee;">
  <a href="https://github.com/jessejii/init" style="display: inline-flex; align-items: center; text-decoration: none; color: #333; font-weight: 600;">
